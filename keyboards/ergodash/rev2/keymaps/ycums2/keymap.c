...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT_kc( \
  ...
  //|------+------+------+------+------+------+------+      |      |------+      +------+------+------+------+------+------|
      XXXXX, XXXXX,  LGUI,         LALT, EISU1, EISU2, SPACE,        XXXXX, SFENT, KANA2,  RALT,        XXXXX, XXXXX, XXXXX \
  //`-------------------------------------------------------'      `-------------------------------------------------------'
  ),
  [_LAYR1] = LAYOUT_kc( \
  //,------------------------------------------------.                    ,------------------------------------------------.
  ...
  //|------+------+------+------+------+------+------+      |      |------+      +------+------+------+------+------+------|
      XXXXX, XXXXX,  LGUI,        CTRAL, LAYR1, LOWER, _____,        XXXXX, CTREN, RAISE, _____,        XXXXX, XXXXX, XXXXX \
  //`-------------------------------------------------------'      `-------------------------------------------------------'
  ),
  [_LOWER] = LAYOUT_kc( \
  //,------------------------------------------------.                    ,------------------------------------------------.
  ...
  //|------+------+------+------+------+------+------|                    |------+------+------+------+------+------+------|
      LCTRL,  HOME, CTRLS,   DEL, RIGHT, CTRLF,  BSPC,                      XXXXX,  BSPC, MINUS,   EQL,  LBRC,  RBRC,  BSLS,\
  //|------+------+------+------+------+------+------+------|      |------+------+------+------+------+------+------+------|
      _____, CTRLZ, CTRLX, CTRLC, CTRLV,  LEFT, RAISE,               XXXXX,         DOWN, _____, _____, _____, _____, _____,\
  //|------+------+------+------+------+------+------+      |      |------+      +------+------+------+------+------+------|
      XXXXX, XXXXX,  LGUI,        _____, LAYR1, LOWER, _____,        XXXXX, SFENT, RAISE, _____,        XXXXX, XXXXX, XXXXX \
  //`-------------------------------------------------------'      `-------------------------------------------------------'
  ),
  ...
  //|------+------+------+------+------+------+------|                    |------+------+------+------+------+------+------|
      GRAVE,     1,     2,     3,     4,     5, XXXXX,                      XXXXX,     6,     7,     8,     9,     0,    UP,\
  //|------+------+------+------+------+------+------|                    |------+------+------+------+------+------+------|
      LCTRL,  HOME, CTRLS,   DEL, RIGHT, _____,  BSPC,                      XXXXX,  BSPC, MINUS,    UP,  LBRC,  RBRC,  BSLS,\
  //|------+------+------+------+------+------+------+------|      |------+------+------+------+------+------+------+------|
  ...
  //|------+------+------+------+------+------+------|                    |------+------+------+------+------+------+------|
      _____,  F11,    F12, _____, _____, _____, _____,                      XXXXX, _____, _____, _____, _____, _____, _____,\
  //|------+------+------+------+------+------+------+------|      |------+------+------+------+------+------+------+------|
      _____, _____, _____, _____, _____, _____, _____,               XXXXX,        _____, _____, _____, _____, _____, _____,\
  //|------+------+------+------+------+------+------+      |      |------+      +------+------+------+------+------+------|
      XXXXX, XXXXX, _____,        _____, _____, _____, _____,        XXXXX, _____, _____, _____,        XXXXX, XXXXX, XXXXX \
  //`-------------------------------------------------------'      `-------------------------------------------------------'
  )
};
