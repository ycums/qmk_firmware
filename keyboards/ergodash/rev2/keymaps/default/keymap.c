...
#define EISU LT(_LOWER,KC_MHEN)
#define KANA LT(_RAISE,KC_HENK)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | GUI  |      | KANA ||||||||  ALt | EISU | Space|      ||||||||      | Enter| KANA |||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LGUI, _______, KANA,             KC_LALT, EISU,    KC_SPC , _______,       _______,KC_ENT , KANA,             KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT \
  ),
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | GUI  |      | KANA ||||||||  ALt | EISU | Space|      ||||||||      | Enter| KANA |||||||| HOME | PgDwn| PgUp | END  |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT,KC_COLN, KC_DQT , \
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_ENT , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_LGUI, _______, KANA,             KC_LALT, EISU,    KC_SPC , _______,       _______,KC_ENT , KANA,             KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
